/*1665526024,,JIT Construction: v1006364963,en_GB*/
...
try {
            ...
            with(this) {
                ...
                __d("sdk.SharedStringConstants", ["sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = {
                        ...
                        logout: c("sdk.fbt")._("Log Out"),
                        logoutButtonAriaLabel: c("sdk.fbt")._("Log out of the current website"),
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1006364963","namespace":"FB","message":"' + e.message + '"}}');
